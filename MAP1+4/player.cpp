...
// ステージ４
#define	PLAYER_POS_X_4		(20)
#define	PLAYER_POS_Y_4		(13)

// ステージ５
#define	PLAYER_POS_X_5		(20)
#define	PLAYER_POS_Y_5		(13)
...
void ControlPlayer(void)
{
	...
	{
		// X軸の当たり判定
		if (GetMapEnter4(D3DXVECTOR2(g_Player.pos.x + g_Player.vel.x, g_Player.pos.y))
			== 1)
		{
			g_Player.pos.x -= g_Player.vel.x;
		}
		// Y軸の当たり判定
		if (GetMapEnter4(D3DXVECTOR2(g_Player.pos.x, g_Player.pos.y + g_Player.vel.y))
			== 1)
		{
			g_Player.pos.y -= g_Player.vel.y;
		}
